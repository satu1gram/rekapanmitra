        ...
        >
            <div className="max-w-md mx-auto flex flex-col items-center justify-center relative px-6 w-full">
                ...
                <div className="relative w-48 h-48 flex items-center justify-center mb-10">
                    ...
                    <div className="absolute inset-0 bg-emerald-100 rounded-full animate-[pulse-soft_2s_cubic-bezier(0.4,0,0.6,1)_infinite]" />
                    {/* Glass inner circle */}
                    <div className="absolute inset-4 bg-white/80 rounded-full backdrop-blur-sm z-10" />
                    {/* Spinning ring */}
                    <div className="relative z-20 w-16 h-16 border-4 border-slate-100 border-t-emerald-600 rounded-full animate-[spin-slow_1.5s_linear_infinite]" />
                </div>
                ...
                <div className="space-y-4 text-center z-10 max-w-[280px]">
                    ...
                    <p className="text-slate-500 text-lg font-medium">Sedang memproses data Anda</p>
                </div>
