    ...
    <div className="min-h-screen bg-background pb-8">
      ...
      <main className="px-4 space-y-4">
        ...
        <footer className="text-center py-6">
          <p className="text-xs font-black text-slate-400 tracking-[0.2em] uppercase">BP Community Manager</p>
          <div className="flex justify-center items-center gap-2 mt-2 opacity-60">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Version 1.1.0</span>
